...
# echo "-----------thead 12-----------------"
# iterations0=1
# OMP_NUM_THREADS=12 numactl -C 12-23 -m 4 ./winograd_dev -ic 3 -oc 64 -is 224 224 -ks 3 3 -ip 1 -a im2col -tn tuning -i $iterations0 
# OMP_NUM_THREADS=12 numactl -C 12-23 -m 4 ./winograd_dev -ic 64 -oc 64 -is 224 224 -ks 3 3 -ip 1 -a im2col -tn tuning -i $iterations0 
# OMP_NUM_THREADS=12 numactl -C 12-23 -m 4 ./winograd_dev -ic 64 -oc 128 -is 112 112 -ks 3 3 -ip 1 -a im2col -tn tuning -i $iterations0
# OMP_NUM_THREADS=12 numactl -C 12-23 -m 4 ./winograd_dev -ic 128 -oc 128 -is 112 112 -ks 3 3 -ip 1 -a im2col -tn tuning -i $iterations0
# OMP_NUM_THREADS=12 numactl -C 12-23 -m 4 ./winograd_dev -ic 128 -oc 256 -is 56 56 -ks 3 3 -ip 1 -a im2col -tn tuning -i $iterations0
# OMP_NUM_THREADS=12 numactl -C 12-23 -m 4 ./winograd_dev -ic 256 -oc 256 -is 56 56 -ks 3 3 -ip 1 -a im2col -tn tuning -i $iterations0
# OMP_NUM_THREADS=12 numactl -C 12-23 -m 4 ./winograd_dev -ic 256 -oc 512 -is 28 28 -ks 3 3 -ip 1 -a im2col -tn tuning -i $iterations0
# OMP_NUM_THREADS=12 numactl -C 12-23 -m 4 ./winograd_dev -ic 512 -oc 512 -is 28 28 -ks 3 3 -ip 1 -a im2col -tn tuning -i $iterations0
# OMP_NUM_THREADS=12 numactl -C 12-23 -m 4 ./winograd_dev -ic 512 -oc 512 -is 14 14 -ks 3 3 -ip 1 -a im2col -tn tuning -i $iterations0

echo "-----------thead 48-----------------"
iterations1=100
OMP_NUM_THREADS=48 numactl -C 12-59 -m 4-7 ./winograd_dev -ic 3 -oc 64 -is 224 224 -ks 3 3 -ip 1 -a im2col -tn tuning -i $iterations1
OMP_NUM_THREADS=48 numactl -C 12-59 -m 4-7 ./winograd_dev -ic 64 -oc 64 -is 224 224 -ks 3 3 -ip 1 -a im2col -tn tuning -i $iterations1
OMP_NUM_THREADS=48 numactl -C 12-59 -m 4-7 ./winograd_dev -ic 64 -oc 128 -is 112 112 -ks 3 3 -ip 1 -a im2col -tn tuning -i $iterations1
OMP_NUM_THREADS=48 numactl -C 12-59 -m 4-7 ./winograd_dev -ic 128 -oc 128 -is 112 112 -ks 3 3 -ip 1 -a im2col -tn tuning -i $iterations1
OMP_NUM_THREADS=48 numactl -C 12-59 -m 4-7 ./winograd_dev -ic 128 -oc 256 -is 56 56 -ks 3 3 -ip 1 -a im2col -tn tuning -i $iterations1
OMP_NUM_THREADS=48 numactl -C 12-59 -m 4-7 ./winograd_dev -ic 256 -oc 256 -is 56 56 -ks 3 3 -ip 1 -a im2col -tn tuning -i $iterations1
OMP_NUM_THREADS=48 numactl -C 12-59 -m 4-7 ./winograd_dev -ic 256 -oc 512 -is 28 28 -ks 3 3 -ip 1 -a im2col -tn tuning -i $iterations1
OMP_NUM_THREADS=48 numactl -C 12-59 -m 4-7 ./winograd_dev -ic 512 -oc 512 -is 28 28 -ks 3 3 -ip 1 -a im2col -tn tuning -i $iterations1
OMP_NUM_THREADS=48 numactl -C 12-59 -m 4-7 ./winograd_dev -ic 512 -oc 512 -is 14 14 -ks 3 3 -ip 1 -a im2col -tn tuning -i $iterations1
