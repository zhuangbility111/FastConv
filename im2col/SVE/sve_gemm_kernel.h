...
void kernel_MxN_for_8x48(int, float *, float *, float *, int, int, svbool_t, svbool_t, svbool_t);

extern const inner_kernel_for_corner_func_t kernel_MxN_for_8x48_func_tab[8][3];

template<int M, int N>
void kernel_MxN_for_12x32(int, float *, float *, float *, int, int, svbool_t, svbool_t, svbool_t);
