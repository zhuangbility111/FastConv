...
void kernel_12x32_no_packa(int kc_adjust, float *packA, float* packB, float *packC, int ldc, const int lda, const int PREFETCH_B, const int PREFETCH_C) {
...
const inner_kernel_no_packa_for_corner_func_t kernel_MxN_for_12x32_no_packa_func_tab[12][2] = {
    {
        kernel_MxN_for_12x32_no_packa<1, 16>,
        kernel_MxN_for_12x32_no_packa<1, 32>
    },
    {
        kernel_MxN_for_12x32_no_packa<2, 16>,
        kernel_MxN_for_12x32_no_packa<2, 32>
    },
    {
        kernel_MxN_for_12x32_no_packa<3, 16>,
        kernel_MxN_for_12x32_no_packa<3, 32>
    },
    {
        kernel_MxN_for_12x32_no_packa<4, 16>,
        kernel_MxN_for_12x32_no_packa<4, 32>
    },
    {
        kernel_MxN_for_12x32_no_packa<5, 16>,
        kernel_MxN_for_12x32_no_packa<5, 32>
    },
    {
        kernel_MxN_for_12x32_no_packa<6, 16>,
        kernel_MxN_for_12x32_no_packa<6, 32>
    },
    {
        kernel_MxN_for_12x32_no_packa<7, 16>,
        kernel_MxN_for_12x32_no_packa<7, 32>
    },
    {
        kernel_MxN_for_12x32_no_packa<8, 16>,
        kernel_MxN_for_12x32_no_packa<8, 32>
    },
    {
        kernel_MxN_for_12x32_no_packa<9, 16>,
        kernel_MxN_for_12x32_no_packa<9, 32>
    },
    {
        kernel_MxN_for_12x32_no_packa<10, 16>,
        kernel_MxN_for_12x32_no_packa<10, 32>
    },
    {
        kernel_MxN_for_12x32_no_packa<11, 16>,
        kernel_MxN_for_12x32_no_packa<11, 32>
    },
    {
        kernel_MxN_for_12x32_no_packa<12, 16>,
        kernel_MxN_for_12x32_no_packa<12, 32>
    },
};

// to-do
void kernel_8x48_no_packa(int kc_adjust, float *packA, float* packB, float *packC, int ldc, const int lda, const int PREFETCH_B, const int PREFETCH_C) {
...
const inner_kernel_no_packa_for_corner_func_t kernel_MxN_for_8x48_no_packa_func_tab[8][3] = {
    {
        kernel_MxN_for_8x48_no_packa<1, 16>,
        kernel_MxN_for_8x48_no_packa<1, 32>,
        kernel_MxN_for_8x48_no_packa<1, 48>
    }, 
    {
        kernel_MxN_for_8x48_no_packa<2, 16>,
        kernel_MxN_for_8x48_no_packa<2, 32>,
        kernel_MxN_for_8x48_no_packa<2, 48>
    },
    {
        kernel_MxN_for_8x48_no_packa<3, 16>,
        kernel_MxN_for_8x48_no_packa<3, 32>,
        kernel_MxN_for_8x48_no_packa<3, 48>
    },
    {
        kernel_MxN_for_8x48_no_packa<4, 16>,
        kernel_MxN_for_8x48_no_packa<4, 32>,
        kernel_MxN_for_8x48_no_packa<4, 48>
    },
    {
        kernel_MxN_for_8x48_no_packa<5, 16>,
        kernel_MxN_for_8x48_no_packa<5, 32>,
        kernel_MxN_for_8x48_no_packa<5, 48>
    },
    {
        kernel_MxN_for_8x48_no_packa<6, 16>,
        kernel_MxN_for_8x48_no_packa<6, 32>,
        kernel_MxN_for_8x48_no_packa<6, 48>
    },
    {
        kernel_MxN_for_8x48_no_packa<7, 16>,
        kernel_MxN_for_8x48_no_packa<7, 32>,
        kernel_MxN_for_8x48_no_packa<7, 48>
    },
    {
        kernel_MxN_for_8x48_no_packa<8, 16>,
        kernel_MxN_for_8x48_no_packa<8, 32>,
        kernel_MxN_for_8x48_no_packa<8, 48>
    }
};

// to-do
// new version, use broadcast and fmla
void kernel_14x32_no_packa(int kc_adjust, float *packA, float* packB, float *packC, int ldc, const int PREFETCH_A, const int PREFETCH_B, const int PREFETCH_C) {
...
// new version, use broadcast and fmla and loop unroll by 2
void kernel_5x64_no_packa(int kc_adjust, float *packA, float* packB, float *packC, int ldc, const int lda, const int PREFETCH_B, const int PREFETCH_C) {
...
void kernel_5x64_no_packa_v1(int kc_adjust, float *packA, float* packB, float *packC, int ldc, const int lda, const int PREFETCH_B, const int PREFETCH_C) {
...
const inner_kernel_no_packa_for_corner_func_t kernel_MxN_for_5x64_no_packa_func_tab[5][4] = {
    {
        kernel_MxN_for_5x64_no_packa<1, 16>,
        kernel_MxN_for_5x64_no_packa<1, 32>,
        kernel_MxN_for_5x64_no_packa<1, 48>,
        kernel_MxN_for_5x64_no_packa<1, 64>
    },
    {
        kernel_MxN_for_5x64_no_packa<2, 16>,
        kernel_MxN_for_5x64_no_packa<2, 32>,
        kernel_MxN_for_5x64_no_packa<2, 48>,
        kernel_MxN_for_5x64_no_packa<2, 64>
    },
    {
        kernel_MxN_for_5x64_no_packa<3, 16>,
        kernel_MxN_for_5x64_no_packa<3, 32>,
        kernel_MxN_for_5x64_no_packa<3, 48>,
        kernel_MxN_for_5x64_no_packa<3, 64>
    },
    {
        kernel_MxN_for_5x64_no_packa<4, 16>,
        kernel_MxN_for_5x64_no_packa<4, 32>,
        kernel_MxN_for_5x64_no_packa<4, 48>,
        kernel_MxN_for_5x64_no_packa<4, 64>
    },
    {
        kernel_MxN_for_5x64_no_packa<5, 16>,
        kernel_MxN_for_5x64_no_packa<5, 32>,
        kernel_MxN_for_5x64_no_packa<5, 48>,
        kernel_MxN_for_5x64_no_packa<5, 64>
    }
};
