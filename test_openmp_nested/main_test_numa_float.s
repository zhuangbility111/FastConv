...
/*    ??? */	sub	sp, sp, 80
	...
	.loc 12 40 0
..LDL6:
/*     40 */	mov	x20, 799997952
/*     40 */	movk	x20, 2048, lsl #0
/*     40 */	mov	x0, x20
/*     40 */	bl	malloc
/*     40 */	add	x19, sp, 8
/*     40 */	str	x0, [x19, 16]
...
/*     75 */	ldr	d4, [x0, :lo12:.LCP1]	//  1.000000e-06
	.loc 12 83 0
..LDL27:
/*     83 */	ldr	d1, [x3, :lo12:.LCP2]	//  2.400000e+04
	.loc 12 85 0
..LDL28:
/*     85 */	adrp	x0, .LR.2
...
..LDL38:
/*     51 */	mov	w5, 1065353216
	.loc 12 52 0
..LDL39:
/*     52 */	mov	w2, 1073741824
	.loc 12 50 0
..LDL40:
/*     50 */	cmp	x1, 8
/*     50 */	bcc	.L238
...
/*     54 */	sub	x1, x1, 4
	.loc 12 51 0
..LDL43:
/*     51 */	str	w5, [x6, x4, lsl #2]	//  (*)
	.loc 12 52 0
..LDL44:
/*     52 */	ldr	x6, [x0, 8]	//  "b"
/*     52 */	str	w2, [x6, x4, lsl #2]	//  (*)
	.loc 12 53 0
..LDL45:
/*     53 */	ldr	x6, [x0]	//  "c"
/*     53 */	str	wzr, [x6, x4, lsl #2]	//  (*)
	.loc 12 51 0
..LDL46:
/*     51 */	ldr	x6, [x0, 16]	//  "a"
/*     51 */	str	w5, [x6, x7, lsl #2]	//  (*)
	.loc 12 52 0
..LDL47:
/*     52 */	ldr	x6, [x0, 8]	//  "b"
/*     52 */	str	w2, [x6, x7, lsl #2]	//  (*)
	.loc 12 53 0
..LDL48:
/*     53 */	ldr	x6, [x0]	//  "c"
/*     53 */	str	wzr, [x6, x7, lsl #2]	//  (*)
	.loc 12 51 0
..LDL49:
/*     51 */	ldr	x6, [x0, 16]	//  "a"
	.p2align 5
...
/*     51 */	ldr	x7, [x0, 16]	//  "a"
/*     51 */	add	x6, x4, 1
/*     51 */	str	w5, [x7, x6, lsl #2]	//  (*)
	.loc 12 52 0
..LDL63:
/*     52 */	ldr	x7, [x0, 8]	//  "b"
/*     52 */	str	w2, [x7, x6, lsl #2]	//  (*)
	.loc 12 53 0
..LDL64:
/*     53 */	ldr	x7, [x0]	//  "c"
/*     53 */	str	wzr, [x7, x6, lsl #2]	//  (*)
	.loc 12 54 0
..LDL65:
/*     54 */	sub	x1, x1, 4
	.loc 12 51 0
...
/*     50 */	cbz	x1, .L187
	.loc 12 51 0 is_stmt 0
..LDL89:
/*     51 */	mov	w2, 1065353216
	.loc 12 52 0
..LDL90:
/*     52 */	mov	w5, 1073741824
	.p2align 5
.L196:					// :entr:term:mod
	.loc 12 51 0 is_stmt 1
..LDL91:
...
/*     54 */	sub	x1, x1, 1
	.loc 12 51 0
..LDL93:
/*     51 */	str	w2, [x6, x4, lsl #2]	//  (*)
	.loc 12 52 0 is_stmt 1
..LDL94:
/*     52 */	ldr	x6, [x0, 8]	//  "b"
/*     52 */	str	w5, [x6, x4, lsl #2]	//  (*)
	.loc 12 53 0
..LDL95:
/*     53 */	ldr	x6, [x0]	//  "c"
/*     53 */	str	wzr, [x6, x4, lsl #2]	//  (*)
...
/*     69 */	cmp	x5, 2
	.loc 12 68 0
..LDL106:
/*     68 */	ldr	s0, [x6, x3, lsl #2]	//  (*)
/*     68 */	ldr	s1, [x2, x3, lsl #2]	//  (*)
/*     68 */	fadd	s0, s0, s1
/*     68 */	str	s0, [x7, x3, lsl #2]	//  (*)
	.loc 12 69 0
..LDL107:
/*     69 */	add	x3, x3, 2
	.loc 12 68 0
...
/*     68 */	ldr	x7, [x0, 8]	//  "b"
/*     68 */	ldr	x6, [x0]	//  "c"
/*     68 */	ldr	s1, [x2, x1, lsl #2]	//  (*)
/*     68 */	ldr	s0, [x7, x1, lsl #2]	//  (*)
/*     68 */	fadd	s0, s1, s0
/*     68 */	str	s0, [x6, x1, lsl #2]	//  (*)
	.loc 12 69 0
..LDL109:
/*     69 */	bcs	.L206
.L211:
